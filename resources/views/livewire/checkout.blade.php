<div class="container mt-2">
    ...
    <div class="row mt-4">
        <div class="col">
            ...
            <hr>
            <p>Untuk pembayaran silahkan transfer di rekening dibawah ini sebesar : <strong>Rp
                    {{ number_format($total_price) }}</strong></p>
            <div class="media">
        ...
        <div class="col">
            ...
            <form wire:submit.prevent="checkout">
                <div class="form-group">
                    ...
                    <input type="text" wire:model="phone_number" name="phone_number" id="phone_number"
                ...
                <div class="form-group">
                    ...
                    <textarea wire:model="address" name="address" id="address"
                        class="form-control @error('order_quantity') is-invalid @enderror"
                        value="{{ old('address') }}" rows="3" required></textarea>
                    @error('address')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
